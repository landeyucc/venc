...
export default {
  ...
  serverSettings: '日誌伺服器設定',
  serverUrl: '伺服器URL',
  encryptSettings: '加密转发設定',
  decryptSettings: '解密转发設定',
  sendFilename: '傳送原始文件名至日誌伺服器',
  sendFileSize: '傳送文件大小至日誌伺服器',
  sendUUID: '傳送UUID至日誌伺服器',
