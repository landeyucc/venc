...
export default {
  ...
  serverSettings: 'Log Server Settings',
  serverUrl: 'Server URL',
  encryptSettings: 'Encryption Forwarding Settings',
  decryptSettings: 'Decryption Forwarding Settings',
  sendFilename: 'Send original filename to log server',
  sendFileSize: 'Send file size to log server',
  sendUUID: 'Send UUID to log server',
